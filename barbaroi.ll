...
(let () (define-here! (-rope/length O) (record/get O 'length))
        (define-here! (-rope/weight O) (record/get O 'weight))
        (define-here! (-rope/left O)   (record/get O 'left))
        (define-here! (-rope/right O)  (record/get O 'right))
        (define! (root-environment) (rope/length O)
                ...
                (cond   ((rope%leaf? O)
                        ...
                        ((null? (-record/right O))
                                (-record/weight O))
                        (else   (+ (-record/weight O)
                                (rope/length (-record/right O))))))
        (-: more... :-))
